...
$.ajax({
  ...
  data: {
    key: 'TVMBZ-5T36J-XETFS-KNMPU-LFVI7-DSBM4',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function getWeibo() {
  fetch('https://hexo.wb.linjiangyu.com/api').then(data => data.json()).then(data => {  // 这里要写上你的API!!!
...
|  | |  |/    \    |  |  \__  \  /    \  / ___<   |  |  |  \
|  |_|  |   |  \   |  |  |/ __ \|   |  \/ /_/  >___  |  |  /
|____/__|___|  /\__|  |__(____  /___|  /\___  // ____|____/ 
             \/\______|       \/     \//_____/ \/          
`,
    "小站已经苟活",
    dnum,
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("08/23/2022 00:00:00");
...
<br>
<center><div style="font-size:1.2em;color:var(--theme-color);font-weight:bold;">------ 再怎么往下啦我也没有啦 ------</div></center>
<br>
